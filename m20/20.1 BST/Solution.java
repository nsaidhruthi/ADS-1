...
public static void main(String[] args)
{
	...
	while(sc.hasNext())
	{
		...
		case "ceiling":
			...
			{
				System.out.println(b11.name+", "+b11.author+", "+b11.price);
			}
			//System.out.println(o.ceiling(a[1]).name+","+o.ceiling(a[1]).author+","+o.ceiling(a[1]).price);
			break;
		case "deleteMax":
			Book b2=o.deleteMax(o.root).key;
			//System.out.println(b2.name+","+b2.author+","+b2.price);
			//System.out.println(.name+", "+o.deleteMax(o.root).key.author+", "+o.deleteMax(o.root).key.price);
			//o.deleteMax(o.root);
			//b.toString();
			break;
		case "deleteMin":
	       // Book b3=o.deleteMin(o.root).key;
	       o.deletemin();
...
Node  deleteMax(Node x)
{
	...
	delete(y.key);
	//System.out.println(y.key.name+",name,"+y.key.author+","+y.key.price);
	return y;
}
